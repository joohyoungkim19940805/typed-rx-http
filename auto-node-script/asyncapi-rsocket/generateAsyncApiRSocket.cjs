...
function generateRouteTypes(asyncapiData, context) {
	...
	lines.push("}");
	lines.push("");
	lines.push("export type AsyncApiRSocketRequest<TRoute extends AsyncApiRSocketRoute> = RSocketOperationRequest<AsyncApiRSocketOperations, TRoute>;");
	lines.push("export type AsyncApiRSocketResponse<TRoute extends AsyncApiRSocketRoute> = RSocketOperationResponse<AsyncApiRSocketOperations, TRoute>;");
	lines.push("export type AsyncApiRSocketInteraction<TRoute extends AsyncApiRSocketRoute> = RSocketOperationInteraction<AsyncApiRSocketOperations, TRoute>;");
	lines.push("export type AsyncApiRSocketStreamRoute = RSocketStreamRoute<AsyncApiRSocketOperations> & AsyncApiRSocketRoute;");
	lines.push("export type AsyncApiRSocketMonoRoute = RSocketMonoRoute<AsyncApiRSocketOperations> & AsyncApiRSocketRoute;");
...
function generateAsyncApiTypes(asyncapiData, sourceName = ASYNC_API_RSOCKET_FILE) {
	...
	lines.push("	RSocketMonoRoute,");
	lines.push("	RSocketOperationInteraction,");
	lines.push("	RSocketOperationRequest,");
	lines.push("	RSocketOperationResponse,");
	lines.push("	RSocketStreamRoute,");
	lines.push("} from '@byeolnaerim/typed-rx-http/rsocket';");
	lines.push("");
